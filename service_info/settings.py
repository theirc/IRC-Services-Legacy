...
AA_CMS_VERSION = '1.0.4-2019-4-19'
...
TRANSIFEX_API_USER = os.environ.get('TRANSIFEX_API_USER')
...
TRANSIFEX_ORGANIZATION_SLUG = os.environ.get('TRANSIFEX_ORGANIZATION_SLUG')
