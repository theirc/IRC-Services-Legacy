...
router.register(r'list-private-providers', v2.PrivateProviderListViewSet)
router.register(r'list-provider-types', v2.ProviderTypeViewSet)
router.register(r'list-service-types', v2.ServiceTypeViewSet)
router.register(r'list-services', v2.ServiceListViewSet)
router.register(r'list-regions', v2.GeographicRegionListViewSet)
