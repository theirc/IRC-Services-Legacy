...
angular.module('adminApp')
    .controller('MenuController', function ($rootScope, $state) {
        var vm = this;
        ...
        function getMenuItems() {
            return [
                    ...
                    items: [
                        {
                            ...
                            items: [
                                {title: 'Newsletter Logs', sref: 'newsletter.logs'},
                                {title: 'Newsletter Settings', sref: 'newsletter.settings'}
                            ],
                        ...
                        },
                        {
                            ...
                            items: [
                                {title: 'Services Overview', sref: 'service.dashboard'},
                                {title: 'Services Management', sref: 'service.list'}
                            ],
                ...
                },
                {
                    ...
                    items: [
                        {title: 'Users Management', sref: 'user.list', active: $state.includes('user')},
                        {
                            title: 'Service Provider Management', sref: 'provider.list',
