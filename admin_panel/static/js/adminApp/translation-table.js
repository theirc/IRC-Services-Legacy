angular.module("adminApp").config(function($translateProvider){
    $translateProvider.translations('en', {
        ...
        SERVICE_TAGS: 'Tags:',
        SERVICE_UPDATE_DATE: 'Service last modification',
        SERVICE_SELECT_DATE: 'Select the date of modification if you want to change it',
    ...
    $translateProvider.translations('es', {
      ...
      SERVICE_CONFIRMATION_NEWSLETTER_LOGS: 'Registro de Newsletter de confirmación de servicios',
        ...
        SERVICE_TAGS: 'Tags',
        SERVICE_UPDATE_DATE: 'Última modificación del servicio',
        SERVICE_SELECT_DATE: 'Elija la fecha de modificación del servicio si desea cambiarla',
